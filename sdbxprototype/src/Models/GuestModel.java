...
public class GuestModel {
    ...
    */
    private ArrayList<RsvModel> _ListRsv;
    public  ArrayList<RsvModel> getListRsv() {return _ListRsv;}
    public void setListRsv( ArrayList<RsvModel> list) {this._ListRsv = list;}
    
    
    //  Model Constructor
    public GuestModel(int guestID, String name, String ccInfo, String email,  ArrayList<RsvModel> listRsv) {
